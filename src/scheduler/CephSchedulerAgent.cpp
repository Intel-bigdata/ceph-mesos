...
#include "CephSchedulerAgent.hpp"
...
void CephSchedulerAgent::reregistered(
      SchedulerDriver* driver,
      const MasterInfo& masterInfo)
{
}

void CephSchedulerAgent::disconnected(SchedulerDriver* driver){}

void CephSchedulerAgent::offerRescinded(
      SchedulerDriver* driver,
      const OfferID& offerId)
{
}

void CephSchedulerAgent::slaveLost(
      SchedulerDriver* driver,
      const SlaveID& slaveId)
{
}

void CephSchedulerAgent::executorLost(
      SchedulerDriver* driver,
...
void CephSchedulerAgent::error(
      SchedulerDriver* driver,
      const std::string& message)
{
}

CephSchedulerAgent::CephSchedulerAgent(Config* _config)
{
  config = _config;
...
void CephSchedulerAgent::statusUpdate(
      SchedulerDriver* driver,
...
void CephSchedulerAgent::frameworkMessage(
      SchedulerDriver* driver,
      const ExecutorID& executorId,
      const SlaveID& slaveId,
      const string& data)
...
void CephSchedulerAgent::resourceOffers(
      SchedulerDriver* driver,
...
string CephSchedulerAgent::getFileServerIP()
{
...
string CephSchedulerAgent::createExecutor(
      string executorName,
      TaskType taskType,
      int token,
...
void CephSchedulerAgent::addHostConfig(TaskInfo &taskinfo, TaskType taskType, string hostname)
{
...
string CephSchedulerAgent::createTaskName(TaskType taskType, int token)
{
  string prefix;
  switch (taskType) {
    case TaskType::MON:
...
void CephSchedulerAgent::handleWaitingOSDTasks(SchedulerDriver* driver)
{
...
bool CephSchedulerAgent::fetchPendingRESTfulRequest()
{
...
bool CephSchedulerAgent::hasRole(const Offer& offer, string role)
{
...
void CephSchedulerAgent::launchNode(
      SchedulerDriver* driver,
      const Offer& offer,
      TaskType taskType,
      int token,
...
bool CephSchedulerAgent::offerNotEnoughResources(const Offer& offer, TaskType taskType)
{
